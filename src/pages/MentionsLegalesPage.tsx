...
const sections = [
  ...
  {
    heading: "Hébergement",
    body: "Le site est hébergé par Netlify, Inc. — 44 Montgomery Street, Suite 300, San Francisco, CA 94104, USA. Site : https://www.netlify.com. Contact : support@netlify.com.",
  },
  {
  ...
  return (
    <>
      <PageMeta
        ...
        description="Mentions légales du site Digitrend Creation."
      />
      <LegalPage
